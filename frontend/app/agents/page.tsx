...
export default function AgentsPage() {
  ...
  return (
    <main id="agents-main" className="flex flex-col items-center px-4 sm:px-8 pb-20">
      ...
      <section id="agents-grid" className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {agents.map((agent, i) => (
          <motion.article 
            key={agent.id}
